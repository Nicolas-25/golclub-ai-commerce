        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 pr-[420px]">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <span className="text-sm font-medium px-3 py-1 bg-red-50 text-red-500 rounded-full">
                ...
                {favorites.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-zinc-50 rounded-2xl border border-zinc-100">
                        ...
                        <h3 className="text-lg font-medium text-zinc-900">Nenhum favorito ainda</h3>
